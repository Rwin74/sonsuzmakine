...
const topics = {
  'kuruyemis-kavurma-makineleri':['kuruyemiş kavurma makinesi','endüstriyel kuruyemiş kavurma','kuruyemiş kurutma makinesi','kavurma üretim hattı'],
  'kilavuzlu-kavurma-makineleri':['kılavuzlu kavurma fırını','dönerli kavurma makinesi','parti tipi kavurma fırını','kuruyemiş kavurma fırını'],
  ...
  'elekler':['kuruyemiş eleği','kuruyemiş eleme makinesi','ürün sınıflandırma ekipmanı','kuruyemiş ayırma hattı'],
  ...
  'cekmeli-kuruyemis-firinlari':['çekmeli kuruyemiş fırını','çekmeceli kavurma fırını','tepsili kuruyemiş fırını','parti tipi kuruyemiş fırını'],
  ...
  'secme-bantlari':['kuruyemiş seçme bandı','ürün ayıklama bandı','kuruyemiş kalite kontrol bandı','seçme konveyörü'],
